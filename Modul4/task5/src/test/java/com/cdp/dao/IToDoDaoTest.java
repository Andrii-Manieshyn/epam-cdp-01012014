...
public class IToDoDaoTest {
    ...
    @Autowired
    public IToDoItemDao iToDoItemDao;
    ...
    private static final String SCHEMA_LOCATION="src/test/resources/schema.sql";

    private static final String DATASET_LOCATION="/META-INF/todoitemtest-dataset/dataset.xml";
    private static final String DATASET_CREATE_OPERATION_LOCATION="/META-INF/todoitemtest-dataset/dataset-create.xml";
    private static final String DATASET_UPDATE_OPERATION_LOCATION="/META-INF/todoitemtest-dataset/dataset-update.xml";
    private static final String DATASET_DELETE_OPERATION_LOCATION="/META-INF/todoitemtest-dataset/dataset-delete.xml";
    ...
    @Test
    @DatabaseSetup(DATASET_LOCATION)
    ...
    @Rollback(value = true)
    @DatabaseSetup(DATASET_LOCATION)
    @ExpectedDatabase(DATASET_CREATE_OPERATION_LOCATION)
    ...
    @Rollback(value = true)
    @DatabaseSetup(DATASET_LOCATION)
    @ExpectedDatabase(DATASET_UPDATE_OPERATION_LOCATION)
    ...
    @Rollback(value = true)
    @DatabaseSetup(DATASET_LOCATION)
    @ExpectedDatabase(DATASET_DELETE_OPERATION_LOCATION)
